...
$if(toc.includes-list)$\KOMAoption{listof}{totoc}$endif$
$endif$
\usepackage{tikz}
\newcommand{\centerboxedHeight}{0.95}
$if(tikzlib)$\usetikzlibrary{$tikzlib$}$endif$
\newcommand{\tmar}{$if(top-margin)$$top-margin$$else$2.5cm$endif$}
\newcommand{\bmar}{$if(bottom-margin)$$bottom-margin$$else$2.5cm$endif$}
\newcommand{\lmar}{$if(left-margin)$$left-margin$$else$3cm$endif$}
\newcommand{\rmar}{$if(right-margin)$$right-margin$$else$2.5cm$endif$}
