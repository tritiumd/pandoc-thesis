...
\setlength{\belowrulesep}{0pt}
\renewcommand{\arraystretch}{1.3}
%end tables-vrules.lua\usepackage{multicol}
...
\newcommand{\frontmatterthesisinfo}[2]{
    ...
    \ifnum#1=1
        \begin{centerboxed}
            ...
            \fontsize{14}{16}\selectfont Trường Đại học Khoa học Tự
nhiên \\
...
học} \\
            ...
            \vspace*{1.5cm}
            \includegraphics[height=3cm,keepaspectratio]{"image/HUS
Logo.jpg"}\\
            \vspace*{1.5cm}
...
markdown} \\
            ...
            {\fontsize{14}{16}\selectfont Thực tập thực tế phát triển
phần mềm}  \\
            {\fontsize{14}{16}\selectfont Ngành: Toán tin}  \\
            \vspace{2cm}
            \fontsize{14}{1}\selectfont\textbf{Người hướng dẫn: Phan
Thanh Ngọc} \\
            \vspace{2cm}
...
\begin{figure}
\centering
\includegraphics{e008901efeda44545fb27b32f54afcbabc0f94ef.pdf}
