...
$else$
\newfontfamily{\mono}{JetBrainsMono}[ Path = /usr/share/fonts/jetbrains-mono/, Extension = .ttf, UprightFont    = *-Regular, ItalicFont     = *-Italic, BoldFont       = *-Bold, BoldItalicFont = *-BoldItalic, ]
$endif$
